        ...
        <div className="Send">
            <div className="child">
                <div className="container">
                    ...
                    <div className={`row d-flex justify-content-${align} mt-3`}>
                    ...
                    <div className={`row mt-md-5 mt-sm-3 d-flex justify-content-${align}`}>
                        <div className="col-12 col-sm-12 col-md-3">
                    ...
                    <div className="row d-flex justify-content-center mt-5">
                        <div className="col-12 col-sm-4">
                            <button type="button" class="btn btn-warning w-100 but1">{`${butText}`}</button>
                        </div>
